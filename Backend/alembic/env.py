...
def get_url():
    print(f"postgresql://{settings.USERNAME_DB}:{settings.PASSWORD_DB}@{settings.HOST_DB}/{settings.NAME_DB}")
    return f"postgresql://{settings.USERNAME_DB}:{settings.PASSWORD_DB}@{settings.HOST_DB}/{settings.NAME_DB}"
